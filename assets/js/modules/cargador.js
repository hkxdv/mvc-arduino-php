...
const MODULOS_POR_PAGINA = {
  arduino: ['arduino_websocket.js'],
  'arduino/mostrar': ['arduino_websocket.js'],
  'arduino/configurar': ['arduino_websocket.js'],
  'arduino/diagnostico': ['arduino_websocket.js'],
  'arduino/webserver': ['arduino_websocket.js']
};
...
async function cargarModulo(nombreModulo) {
  try {
    ...
    const rutaCompleta = `./${nombreModulo}`;
