    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden max-w-2xl w-full">
        <div class="p-6">
            <div class="flex items-center justify-center mb-6">
                <div class="w-16 h-16 rounded-full bg-purple-100 flex items-center justify-center mr-3">
                    <i class="fas fa-exclamation-triangle text-purple-500 text-2xl"></i>
                </div>
            </div>
            
            <div class="text-center mb-6">
                <h1 class="text-6xl font-bold mb-2 text-gray-800"><?php echo $codigo ?? 'Error'; ?></h1>
                <h2 class="text-2xl font-semibold mb-4 text-blue-600"><?php echo $titulo ?? 'Error del Sistema'; ?></h2>
                <p class="text-lg mb-6 text-gray-600"><?php echo $mensaje ?? 'Se ha producido un error inesperado.'; ?></p>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-center gap-4 mb-4">
                ...
                <button onclick="window.location.reload()" class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded transition-colors flex items-center justify-center">
