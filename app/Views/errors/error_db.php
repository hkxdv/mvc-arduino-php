    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden max-w-2xl w-full">
        <div class="p-6">
            ...
            <div class="text-center mb-6">
                <h1 class="text-6xl font-bold mb-2 text-gray-800">500</h1>
                <h2 class="text-2xl font-semibold mb-4 text-blue-600"><?php echo $titulo ?? 'Error de Conexión'; ?></h2>
                <p class="text-lg mb-6 text-gray-600"><?php echo $mensaje ?? 'Error de conexión a la base de datos. Por favor, intente más tarde.'; ?></p>
            </div>
