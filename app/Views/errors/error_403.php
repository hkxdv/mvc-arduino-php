    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden max-w-2xl w-full">
        <div class="p-6">
            <div class="flex items-center justify-center mb-6">
                <div class="w-16 h-16 rounded-full bg-yellow-100 flex items-center justify-center mr-3">
                    <i class="fas fa-lock text-yellow-500 text-2xl"></i>
                </div>
            </div>
            
            <div class="text-center mb-6">
                <h1 class="text-6xl font-bold mb-2 text-gray-800">403</h1>
                <h2 class="text-2xl font-semibold mb-4 text-blue-600"><?php echo $titulo ?? 'Acceso Prohibido'; ?></h2>
                <p class="text-lg mb-6 text-gray-600"><?php echo $mensaje ?? 'No tienes permisos para acceder a este recurso.'; ?></p>
            </div>
